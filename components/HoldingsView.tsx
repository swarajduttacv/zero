    ...
    <div className="space-y-6">
      <div className="flex justify-between items-end">
        ...
        <div className="flex gap-2">
            ...
            <button className="px-4 py-2 bg-brand-500 text-white rounded-lg text-sm font-medium hover:bg-brand-600">Quick Analysis</button>
        </div>
      </div>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-brand-800">
              {portfolio.holdings.length === 0 ? (
                <tr><td colSpan={6} className="px-6 py-12 text-center text-gray-500">No active holdings found in your Zerodha profile.</td></tr>
              ) : (
                portfolio.holdings.map((stock) => {
                    ...
                    <tr key={stock.symbol} className="hover:bg-brand-800/30 transition-colors">
                        ...
                        <td className={`px-6 py-4 text-right font-mono ${pnl >= 0 ? 'text-profit' : 'text-loss'}`}>
